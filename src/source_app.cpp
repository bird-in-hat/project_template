...
ClassName::ClassName() : message_("") {}

void ClassName::help(const char* appname, const char* message) {
    message_ =
        std::string(message) +
...
bool ClassName::validateNumberOfArguments(int argc, const char** argv) {
    if (argc == 1) {
        help(argv[0]);
        return false;
    } else if (argc != 6) {
...
std::string ClassName::operator()(int argc, const char** argv) {
    Arguments args;
